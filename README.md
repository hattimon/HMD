...
## 🛰️ Heltec Indoor Hotspot Dashboard
Target device:
...
### ⚙️ Install on Heltec (from this repo)
```bash
sudo -i
...
## 🛰️ Dashboard dla Heltec Indoor Hotspot
Urządzenie docelowe:
- **HT‑M2808 Indoor Hotspot for Helium**
...
### ⚙️ Instalacja na Heltecu (z tego repozytorium)
```bash
sudo -i
curl -fsSL https://raw.githubusercontent.com/hattimon/HMD/main/heltec/helium-dashboard.sh -o /opt/helium-dashboard.sh
chmod +x /opt/helium-dashboard.sh
